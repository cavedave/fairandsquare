...
d.parentNode.insertBefore(e,d);if(b){a.extend(c,b);}return this.each(function(){var f=["iframe[src*='player.vimeo.com']","iframe[src*='www.youtube.com']","iframe[src*='www.kickstarter.com']","iframe[src*='www.dailymotion.com']","object","embed"];
...
});});};})(jQuery);jQuery(document).ready(function(a){a(".post-video, .video-embed, #portfolio-video, .widget_embed").fitVids();});